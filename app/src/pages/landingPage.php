        ...
        <div class="card bg-gradient-light" style="width: 72%;">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-dark" role="alert">
                    <strong>Warning!</strong> This is a temporary landing page. 
                    <br>We are working hard on getting this application up and running. 
                    <br>In the mean time check out our promotional video <a
