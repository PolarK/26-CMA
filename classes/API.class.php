...
{   
    ...
    static function request()
    {
        ...
        $rawData = substr(basename($arg_0), strpos(basename($arg_0), "=")+1); 

        $encodedData = rawurlencode(substr(basename($arg_0), strpos(basename($arg_0), "=")+1)); 

        $url = str_replace($rawData, $encodedData, $arg_0); 
